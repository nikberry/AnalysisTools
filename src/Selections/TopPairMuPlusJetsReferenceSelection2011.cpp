...
bool TopPairMuPlusJetsReferenceSelection2011::isGoodPhoton(const PhotonPointer photon, const EventPtr event) const {
...
const PhotonCollection TopPairMuPlusJetsReferenceSelection2011::signalPhotons(const EventPtr event) const {
