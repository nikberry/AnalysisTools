...
// need to change to rhgo corrected?
	for (unsigned int index = 0; index < nMinusOnePhotons.size(); ++index) {
		...
		if(cut=="passesSafeElectronVeto"){
			histMan_->H1D_BJetBinned("Photon_ConvSafeEleVeto")->Fill(photon->ConversionSafeElectronVeto(), weight_);
		}
		...
		if (cut =="passesPFNeutralIso"){
			histMan_->H1D_BJetBinned("Photon_PFNeutralHadronIso")->Fill(photon->PFNeutralHadronIso(), weight_);
			histMan_->H1D_BJetBinned("Photon_RhoCorrectedPFNeutralHadronIso")->Fill(photon->RhoCorrectedPFNeutralHadronIso(event->rho()), weight_);
		}

		if (cut =="passesPFPhotonIso"){
			histMan_->H1D_BJetBinned("Photon_PFPhotonIso")->Fill(photon->PFPhotonIso(), weight_);
			histMan_->H1D_BJetBinned("Photon_RhoCorrectedPFPhotonIso")->Fill(photon->RhoCorrectedPFPhotonIso(event->rho()), weight_);
		}		
		...
		if (photon->isInBarrelRegion() && cut =="passesphoSCChIso"){
			histMan_->H1D_BJetBinned("Photon_SCChIso_barrel")->Fill(photon->phoSCChIso(), weight_);
			histMan_->H1D_BJetBinned("Photon_RhoCorrectedSCChIso_barrel")->Fill(photon->RhoCorrectedSCChIso(event->rho()), weight_);
		}
...
void PhotonAnalyser::createHistograms() {
	...
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedPFChargedHadronIso", "Charged Hadron Isolation (#rho corr) / GeV; ; Events", 50, 0, 10);
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedPFNeutralHadronIso", "Neutral Hadron Isolation (#rho corr) / GeV; ; Events", 50, 0, 10);
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedPFPhotonIso", "Photon Isolation (#rho corr) / GeV; ; Events", 50, 0, 10);
	...
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedSCChIso_barrel", "SCFR Ch. Had.Iso. (#rho-corr)", 600, -20, 100);
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedSCNuIso_barrel", "SCFR Nu. Had.Iso. (#rho-corr)", 600, -20, 100);
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedSCPhIso_barrel", "SCFR Photon Iso. (#rho-corr)", 600, -20, 100);
	histMan_->addH1D_BJetBinned("Photon_deltaR_jets_barrel", "Photon #DeltaR(#gamma, jets); #DeltaR(#gamma, jets); Events", 500, 0, 5);
	histMan_->addH1D_BJetBinned("Photon_deltaR_electrons_barrel", "Photon #DeltaR(#gamma, electrons); #DeltaR(#gamma, electrons); Events", 500, 0, 5);
	histMan_->addH1D_BJetBinned("Photon_deltaR_muons_barrel", "Photon #DeltaR(#gamma, #mu); #DeltaR(#gamma, #mu); Events", 500, 0, 5);		
	...
	histMan_->addH1D_BJetBinned("Photon_deltaR_jets_endcap", "Photon #DeltaR(#gamma, jets); #DeltaR(#gamma, jets); Events", 500, 0, 5);
	histMan_->addH1D_BJetBinned("Photon_deltaR_electrons_endcap", "Photon #DeltaR(#gamma, electrons); #DeltaR(#gamma, electrons); Events", 500, 0, 5);
	histMan_->addH1D_BJetBinned("Photon_deltaR_muons_endcap", "Photon #DeltaR(#gamma, #mu); #DeltaR(#gamma, #mu); Events", 500, 0, 5);
	...
	histMan_->addH1D_BJetBinned("Photon_Eta", "Photon #eta; #eta(#gamma); Events/(0.02)", 300, -3, 3);
	histMan_->addH1D_BJetBinned("Photon_AbsEta", "Photon |#eta|; |#eta(#gamma)|; Events/(0.01)", 300, 0, 3);
	histMan_->addH1D_BJetBinned("Photon_ConvSafeEleVeto", "Photon Conversion Safe Electron Veto; 0=false, 1=true; Events", 2, 0, 2);
	histMan_->addH1D_BJetBinned("Photon_HadOverEM", "Photon HadronicOverEM; HadOverEM; Events/(0.01)", 500, 0, 0.5);
	histMan_->addH1D_BJetBinned("Photon_ET", "Photon E_{T}; E_{T}(#gamma); Events/(1 GeV)", 500, 0, 500);
	histMan_->addH1D_BJetBinned("Photon_deltaR_jets", "Photon #DeltaR(#gamma, jets); #DeltaR(#gamma, jets); Events", 500, 0, 5);
	histMan_->addH1D_BJetBinned("Photon_deltaR_electrons", "Photon #DeltaR(#gamma, electrons); #DeltaR(#gamma, electrons); Events", 500, 0, 5);
	histMan_->addH1D_BJetBinned("Photon_deltaR_muons", "Photon #DeltaR(#gamma, #mu); #DeltaR(#gamma, #mu); Events", 500, 0, 5);
	histMan_->addH1D_BJetBinned("Photon_ConvSafeEleEVeto", "Photon Conversion Safe Electron Veto; 0=false, 1=true; Events", 2, 0, 2);
	histMan_->addH1D_BJetBinned("Photon_HtowoE", "Photon Single Tower HoverE; ; Events", 500, 0, 0.5);
//	histMan_->addH1D_BJetBinned("Photon_PFChargedHadronIso", "Photon PFChargedHadronIso; ; Events", 500, -20, 100);
	histMan_->addH1D_BJetBinned("Photon_PFNeutralHadronIso", "Photon PFNeutralHadronIso; ; Events", 500, -20, 50);
	histMan_->addH1D_BJetBinned("Photon_PFPhotonIso", "Photon PFPhotonIso; ; Events", 500, -20, 130);
...
//	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedPFChargedHadronIso_barrel", "Charged Hadron Iso (#rho-corr); ; Events", 500, -20, 100);
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedPFNeutralHadronIso_barrel", "Neutral Hadron Iso (#rho-corr); ; Events", 500, -20, 50);
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedPFPhotonIso_barrel", "Photon Iso (#rho-corr); ; Events", 500, -20, 130);
	histMan_->addH1D_BJetBinned("Photon_SCChIso_barrel", "SCFR Charged Hadron Iso (barrel); ; Events", 110, -20, 110);
	histMan_->addH1D_BJetBinned("Photon_RhoCorrectedSCChIso_barrel", "SCFR Ch. Had.Iso. (#rho-corr)", 600, -20, 100);		
