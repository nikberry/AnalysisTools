...
// namespace BAT {
// 
// class TTbarLooseSeletionAnalyser: public BAT::BasicAnalyser {
// public:
// 	TTbarLooseSeletionAnalyser(HistogramManagerPtr histMan, std::string histogramFolder = "TTbarLooseSeletionAnalysis");
// 	virtual ~TTbarLooseSeletionAnalyser();
...
// };
// 
// typedef boost::scoped_ptr<BAT::TTbarLooseSeletionAnalyser> TTbarLooseSeletionAnalyserLocalPtr;
// } /* namespace BAT */
