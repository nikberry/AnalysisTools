/*********************************************************|                                                                                                                                                                        
 *          TopPairEELooseReferenceSelection.h            |
 *                                                        |
 *                  Author: N.Berry                       |
 *                                                        |
 *********************************************************/

#ifndef TOPPAIREELOOSEREFERENCESELECTION_H_
#define TOPPAIREELOOSEREFERENCESELECTION_H_

#include "BasicSelection.h"

namespace BAT {

namespace TTbarEELooseReferenceSelection {
enum Step {
...
class TopPairEELooseReferenceSelection: public BAT::BasicSelection {
public:
	TopPairEELooseReferenceSelection(unsigned int numberOfSelectionSteps =
			TTbarEELooseReferenceSelection::NUMBER_OF_SELECTION_STEPS);
	virtual ~TopPairEELooseReferenceSelection();
...
typedef boost::shared_ptr<TopPairEELooseReferenceSelection> TopPairEELooseReferenceSelectionPointer;

} /* namespace BAT */
#endif /* TOPPAIREELOOSEREFERENCESELECTION_H_ */
