...
void Analysis::initiateEvent() {
	...
	//top pt weight
  	if(Globals::applyTopPtReweighting == true && (currentEvent->getDataType() == DataType::TTJets || currentEvent->getDataType() == DataType::TTGamma || currentEvent->getDataType() == DataType::TTGamma_2to7)){
